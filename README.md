...
<head>
    ...
    <style>
        :root {
            ...
            --blue-gradient-light: linear-gradient(135deg, #2A4F7A, #3A6FA0);
        }
        ...
        * {
        ...
        /* ========== أنماط شواهد الأداء الوظيفي (القسم الجديد) ========== */
        .teacher-info-card {
            background: var(--blue-gradient);
            color: white;
            padding: 20px;
        ...
        @keyframes pulse {
            0% { box-shadow: 0 0 0 0 rgba(245, 215, 110, 0.4); }
            70% { box-shadow: 0 0 0 10px rgba(245, 215, 110, 0); }
        ...
        .tab-2 .section-description {
            border-right-color: var(--primary-light);
        }

        .tab-3 .section-description {
        ...
        @media (max-width: 768px) {
            ...
            /* تحسينات لشواهد الأداء الوظيفي على الجوال */
            .pdf-embed-container {
                height: 70vh;
                min-height: 400px;
            }
        ...
        @media (max-width: 480px) {
            ...
            /* تحسينات لشواهد الأداء الوظيفي على الشاشات الصغيرة */
            .pdf-embed-container {
                height: 60vh;
                min-height: 300px;
            }
...
<body>
        ...
        <div class="header-container">
            ...
            <div class="nav-container">
                ...
                <div class="nav-scroll" id="navScroll">
                    ...
                    <!-- إضافة رابط شواهد الأداء الوظيفي هنا -->
                    <a href="#portfolio" class="nav-item" data-section="portfolio">
                        <i class="fas fa-folder-open"></i>
                        <span id="navPortfolio">شواهد الأداء</span>
                    </a>
    ...
    <main>
        ...
        <!-- ========== شواهد الأداء الوظيفي (القسم الجديد) ========== -->
        <section id="portfolio">
            <h2 class="section-title" id="portfolioTitle">شواهد الأداء الوظيفي</h2>
            <div class="card fade-in-up">
                <div class="portfolio-section">
                    <div class="teacher-info-card">
                        <h3>المعلم فهد نغيمش حميد الخالدي</h3>
                        <p>معلم متقدم في اللغة الإنجليزية - 13+ سنة خبرة في التعليم</p>
                    </div>
                    
                    <div class="tabs-instruction">
                        <i class="fas fa-hand-point-down"></i>
                        <span>انقر على أي قسم أدناه لعرض محتوياته</span>
                        <i class="fas fa-hand-point-down"></i>
                    </div>
                    ...
                    <div class="tabs-container">
                        <div class="tabs">
                            <div class="tab tab-1 active" data-tab="1">
                                <i class="fas fa-file-certificate tab-icon"></i>
                                <span>الشواهد الوظيفية</span>
                            </div>
                            <div class="tab tab-2" data-tab="2">
                                <i class="fas fa-user-graduate tab-icon"></i>
                                <span>سجل متابعة الطلاب</span>
                            </div>
                    ...
                    <!-- Tab 1 Content: الشواهد الوظيفية -->
                    <div class="tab-content active" id="tab-1">
                        <div class="section-description">
                            <h4><i class="fas fa-info-circle"></i> عن هذا القسم</h4>
                            <p>يحتوي هذا القسم على الشواهد والأدلة المهنية التي توضح الخبرات والإنجازات التعليمية. يشمل الشهادات والدورات التدريبية والجوائز والتكريمات التي حصل عليها المعلم خلال مسيرته المهنية.</p>
                        </div>
                        
                        <div class="pdf-container">
                            <!-- PDF Header -->
                            <div class="pdf-header">
                                <h2>ملف الشواهد الوظيفية</h2>
                                <div class="pdf-actions">
                                    <button class="btn btn-primary fullscreen-trigger" data-tab="1">
                            ...
                            <!-- PDF Viewer -->
                            <div class="pdf-embed-container" id="pdfContainer-1">
                            ...
                            <div class="pdf-note">
                                <div class="update-notice">
                                    ...
                                    سيتم تحديث الملف دوريًا لإضافة الشواهد الجديدة
                                </div>
                            </div>
                        </div>
                    </div>

                    <!-- Tab 2 Content: سجل متابعة الطلاب -->
                    <div class="tab-content" id="tab-2">
                        <div class="section-description">
                            <h4><i class="fas fa-info-circle"></i> عن هذا القسم</h4>
                            <p>يحتوي هذا القسم على سجل متابعة الطلاب وتقييم أدائهم الأكاديمي والسلوكي. يتضمن تقارير عن تقدم الطلاب، ومستويات تحصيلهم، وخطط الدعم الفردية، ونتائج التقويم المستمر.</p>
                        </div>
                        
                        <div class="pdf-container">
                            <!-- PDF Header -->
                            <div class="pdf-header">
                                <h2>سجل متابعة الطلاب</h2>
                                <div class="pdf-actions">
                                    <button class="btn btn-primary fullscreen-trigger" data-tab="2">
                                        <i class="fas fa-expand"></i>
                                        <span>عرض ملء الشاشة</span>
                                    </button>
                                </div>
                            ...
                            <!-- PDF Viewer -->
                            <div class="pdf-embed-container" id="pdfContainer-2">
                                <!-- سيتم تحميل الـ PDF هنا -->
                            </div>
                            ...
                            <div class="pdf-note">
                                <div class="update-notice">
                                    ...
                                    يتم تحديث سجل المتابعة أسبوعيًا بناءً على أداء الطلاب
                                </div>
                            </div>
                        </div>
                    </div>

                    <!-- Tab 3 Content: الخطط الأسبوعية -->
                    <div class="tab-content" id="tab-3">
                        <div class="section-description">
                            <h4><i class="fas fa-info-circle"></i> عن هذا القسم</h4>
                            <p>يحتوي هذا القسم على الخطط الأسبوعية للدروس والأنشطة التعليمية. يتضمن الأهداف التعليمية، والاستراتيجيات التدريسية، والأنشطة الصفية واللاصفية، وأدوات التقويم المستخدمة.</p>
                        </div>
                        
                        <div class="pdf-container">
                            <!-- PDF Header -->
                            <div class="pdf-header">
                                <h2>الخطط الأسبوعية للدروس</h2>
                                <div class="pdf-actions">
                                    <button class="btn btn-primary fullscreen-trigger" data-tab="3">
                                        <i class="fas fa-expand"></i>
                                        <span>عرض ملء الشاشة</span>
                                    </button>
                                </div>
                            ...
                            <!-- PDF Viewer -->
                            <div class="pdf-embed-container" id="pdfContainer-3">
                                <!-- سيتم تحميل الـ PDF هنا -->
                            </div>
                            ...
                            <div class="pdf-note">
                                <div class="update-notice">
                                    ...
                                    يتم إعداد الخطط الأسبوعية مسبقًا وتحديثها حسب الحاجة
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        ...
        const translations = {
            ar: {
                ...
                portfolioTitle: "شواهد الأداء الوظيفي",
            ...
            en: {
                ...
                portfolioTitle: "Performance Evidence",
                ...
                navSkills: "Skills",
                navPortfolio: "Performance Evidence",
                navTrain: "Training",
                navTech: "Technology",
        ...
        // ========== إدارة تبويبات شواهد الأداء الوظيفي ==========
        
        // تهيئة تبويبات شواهد الأداء الوظيفي
        function initPortfolioTabs() {
            ...
            tabs.forEach(tab => {
                tab.addEventListener('click', () => {
                    ...
                    // تحميل ملف PDF للتبويب الجديد
                    loadPdfForTab(tabId);
                });
            });
            
            // تحميل ملفات PDF لكل تبويب
            const pdfUrls = {
                1: 'https://drive.google.com/file/d/109O8XbxTbS6R3ZyO6SgKzZYYJpa6d7Ty/preview?rm=minimal&toolbar=0&navpanes=0&view=FitH',
                2: 'https://drive.google.com/file/d/1Jo7dr-mdYCSQjNremD7ROl4tWsTFVrrm/preview?rm=minimal&toolbar=0&navpanes=0&view=FitH',
                3: 'https://drive.google.com/file/d/1-MJGMUt-VosAyBKqUQL70H1uQpLwX5oF/preview?rm=minimal&toolbar=0&navpanes=0&view=FitH'
            };
            
            // دالة لتحميل ملف PDF لتبويب معين
            function loadPdfForTab(tabId) {
                const pdfContainer = document.getElementById(`pdfContainer-${tabId}`);
                
                // إذا كان الملف قد تم تحميله مسبقًا، لا نحتاج لإعادة تحميله
                if (pdfContainer.querySelector('iframe')) {
                    return;
                }
                
                // رابط PDF مع إعدادات لإخفاء جميع العناصر
                let pdfUrl = pdfUrls[tabId];
                
                // إذا كان الرابط غير متوفر، نستخدم رابطًا افتراضيًا
                if (!pdfUrl) {
                    pdfUrl = 'https://drive.google.com/file/d/109O8XbxTbS6R3ZyO6SgKzZYYJpa6d7Ty/preview?rm=minimal&toolbar=0&navpanes=0&view=FitH';
                }
                
                // إنشاء iframe لتحميل PDF
                const iframe = document.createElement('iframe');
                iframe.id = `pdfViewer-${tabId}`;
                iframe.src = pdfUrl;
                ...
                // عناوين مختلفة لكل تبويب
                const tabTitles = {
                    1: 'ملف الشواهد الوظيفية',
                    2: 'سجل متابعة الطلاب',
                    3: 'الخطط الأسبوعية للدروس'
                };
                
                iframe.title = tabTitles[tabId] || `ملف الإنجاز - تبويب ${tabId}`;
                ...
                iframe.onload = function() {
                    console.log(`تم تحميل ملف PDF للتبويب ${tabId} بنجاح`);
                    iframe.style.opacity = '1';
                };
                
                // معالجة الأخطاء
                iframe.onerror = function() {
                    console.error(`حدث خطأ في تحميل ملف PDF للتبويب ${tabId}`);
                    pdfContainer.innerHTML = `
                        <div style="padding: 40px; text-align: center; color: #666;">
                            <i class="fas fa-file-pdf" style="font-size: 3rem; color: var(--primary); margin-bottom: 20px;"></i>
                            <h3 style="color: var(--primary); margin-bottom: 10px;">تعذر تحميل الملف</h3>
                            <p>حدث خطأ في تحميل ملف PDF. يرجى التحقق من اتصال الإنترنت أو المحاولة لاحقًا.</p>
                            <button onclick="loadPdfForTab(${tabId})" style="margin-top: 20px; padding: 10px 20px; background: var(--primary); color: white; border: none; border-radius: 5px; cursor: pointer;">
            ...
            // تحميل ملف PDF للتبويب الأول عند بدء التحميل
            loadPdfForTab(1);
            
            // إضافة أحداث لأزرار ملء الشاشة
            const fullscreenTriggers = document.querySelectorAll('.fullscreen-trigger');
            
            fullscreenTriggers.forEach(trigger => {
                trigger.addEventListener('click', () => {
                    const tabId = trigger.getAttribute('data-tab');
                    togglePortfolioFullscreen(tabId);
                });
            });
            
            // وظيفة ملء الشاشة للتبويبات
            function togglePortfolioFullscreen(tabId) {
                const pdfContainer = document.getElementById(`pdfContainer-${tabId}`);
                ...
                if (!pdfContainer.classList.contains('fullscreen')) {
                    ...
                    setTimeout(() => {
                        const iframe = document.getElementById(`pdfViewer-${tabId}`);
                        if (iframe) {
            ...
            // إضافة حدث للخروج من وضع ملء الشاشة
            const exitFullscreenBtn = document.getElementById('exitFullscreenBtn');
            if (exitFullscreenBtn) {
                exitFullscreenBtn.addEventListener('click', exitPortfolioFullscreen);
            }
            
            function exitPortfolioFullscreen() {
                ...
                const pdfContainers = document.querySelectorAll('.pdf-embed-container');
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            setTimeout(() => {
                ...
                welcomeMessage.innerHTML = `
                    <p><i class="fas fa-mouse-pointer"></i> مرحباً! يمكنك التنقل بين الأقسام باستخدام شريط التنقل الأعلى</p>
                `;
